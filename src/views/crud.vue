  ...
  >
    ...
    >
      ...
      <el-form-item label="显示信息">
        <el-select
          v-model="boothChanged.show"
          :placeholder="showDict[booth.show]"
        >
      ...
      <el-form-item label="展台人数" prop="count">
        <el-input
          v-model="boothChanged.count"
          :placeholder="booth.count.toString()"
        />
      </el-form-item>
      <el-form-item label="等待时间" prop="minutes">
        <el-input
          v-model="boothChanged.minutes"
          :placeholder="booth.minutes.toString()"
        />
      </el-form-item>
      ...
      <el-form-item>
        <el-button
          ...
          style="width: 240px"
          class="submit"
          :disabled="!changeAble.count || !changeAble.minutes"
          type="primary"
        >
          修改
        </el-button>
